...
// /**
//  * 
//  * @param c will implement the move refactor, this is not just moving the class to given file but also updating, in given project, all references of import declarations that point to the class so they point to the new file. 
