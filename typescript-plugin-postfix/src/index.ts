...
// import { findChildContainedRange, findChildContainingRange, getKindName, positionOrRangeToNumber,
// positionOrRangeToRange } from 'typescript-ast-util';
...
const pluginDefinition = { getApplicableRefactors, getEditsForRefactor, getCodeFixesAtPosition, getCombinedCodeFix, getCompletionsAtPosition }
