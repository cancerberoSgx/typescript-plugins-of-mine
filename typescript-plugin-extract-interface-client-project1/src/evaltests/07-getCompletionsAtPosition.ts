...
function completionsTest1() {
    ...
    // c.util.guestEmitter.emit('requestEvalCurrentFunctionSelection', '/home/sg/git/typescript-plugins-of-mine/typescript-plugin-extract-interface-client-project1/src/evaltests/07-getCompletionsAtPosition.ts', 769,  'declare const variable', {}, '')
