...
//   foo: () => { return 1 }
// }
// const val: string[] = o.bar(1, ['w'], true) // decare missing member to an object literal
// interface Hello {}
// const hello: Hello = {}
// let i: string[] = hello.world([[1, 2, 3], [4, 5]]) // decare missing member to instance's interface
// const k = hello.mama(1, 2, 3) + ' how are you?' // same as before - notice inferred return type
// function f(h: Hello) {
//   h.fromFunc = true // same as before - notice the instance if a paramter decl
// }
// var x: Date = new Date(hello.timeWhen('born')) // same as before - notice inferred return type
// class C {
//   hello: Hello
//   m(s: number[]) { this.hello.grasp(s, [false, true]) } // same as before - notice instance is a property access
// }
// const notDefined:C
// const a = notDefined.foo + 9
